...
import {
  getTasksByDateRange, getUniqItems, calculateBetweenDates,
  createPlaceholder, createRandomColor, calcUniqCountColor,
  ...
  return new Chart(colorsCtx, {
    ...
    options: {
      ...
      tooltips: {
        ...
        bodyFontColor: CHART_TEXT_COLOR,
  ...
  return new Chart(daysCtx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        pointRadius: 8,
        pointHoverRadius: 8,
        pointBackgroundColor: CHART_TEXT_COLOR
      }]
    },
    options: {
      plugins: {
        datalabels: {
          ...
          color: CHART_TEXT_COLOR_INVERSE
        }
      },
      scales: {
        yAxes: [{
